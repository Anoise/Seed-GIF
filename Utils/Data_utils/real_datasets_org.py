...
class CustomDataset(Dataset):
    def __init__(
        ...
        print('dataset seq_len, pred_len = ', seq_len, pred_len)
        ...
        self.sample_num_total = max(self.len - self.seq_len + 1, 0)
        ...
        if proportion>0:
            ...
            self.samples = self.__getwindows(self.data)
