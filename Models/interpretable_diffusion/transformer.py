...
class Transformer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.pos_enc = LearnablePositionalEncoding(n_embd, dropout=resid_pdrop, max_len=n_channel)
        ...
        self.pos_dec = LearnablePositionalEncoding(n_embd, dropout=resid_pdrop, max_len=n_channel)
